  ...
  return (
    <div className="instructionsText" id="instOverlay">
      <div className="instCont">
        ...
        <br />
        <p>If the guess has no digits correct:</p>
        <img style={BAGEL} src={bagel} alt="" />
        <p>For each correct digit in the wrong place:</p>
        <img style={PICO} src={pico} alt="" />
        <p>For each correct digit in the correct place:</p>
        <img style={FERMI} src={fermi} alt="" />
      </div>
    </div>
  );
}
